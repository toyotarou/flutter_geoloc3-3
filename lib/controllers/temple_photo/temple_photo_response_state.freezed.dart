    ...
    return _then(_value.copyWith(
      templePhotoList: null == templePhotoList
          ...
          : templePhotoList // ignore: cast_nullable_to_non_nullable
              as AsyncValue<List<TemplePhotoModel>>,
      templePhotoTempleMap: null == templePhotoTempleMap
          ...
          : templePhotoTempleMap // ignore: cast_nullable_to_non_nullable
              as AsyncValue<Map<String, List<TemplePhotoModel>>>,
...
class _$TemplePhotoResponseStateImpl implements _TemplePhotoResponseState {
  const _$TemplePhotoResponseStateImpl(
      ...
      this.templePhotoTempleMap =
          const AsyncValue<Map<String, List<TemplePhotoModel>>>.loading(),
      this.templePhotoDateMap =
          const AsyncValue<Map<String, List<TemplePhotoModel>>>.loading()});
  ...
  @override
  @JsonKey()
  final AsyncValue<Map<String, List<TemplePhotoModel>>> templePhotoTempleMap;
  @override
  @JsonKey()
  final AsyncValue<Map<String, List<TemplePhotoModel>>> templePhotoDateMap;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.templePhotoTempleMap, templePhotoTempleMap) ||
                other.templePhotoTempleMap == templePhotoTempleMap) &&
            (identical(other.templePhotoDateMap, templePhotoDateMap) ||
                other.templePhotoDateMap == templePhotoDateMap));
  }
